// CalendarSupplierPanel — owner-facing Google Calendar supplier card.
// Three blocks:
...
//
// The design mockups have no dedicated GCal card; this follows the SupplierTile visual
