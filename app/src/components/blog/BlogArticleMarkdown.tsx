...
// 从 BlogArticle 拆出来守 350-line cap。所有样式落在
// BlogArticleMarkdown.module.css —— 这个文件只组装 element + 处理 inline /
// fence code 分流 + 外链 rel 注入，不再 carry typography 数字。
//
// markdown body 整体挂 styles.body class（caller 由 BlogArticle 提供）；
// 描述性 selectors `.body h1` / `.body p` 等接管字体 / 间距。

import type { ReactNode } from 'react';

import styles from '@/components/blog/BlogArticleMarkdown.module.css';
