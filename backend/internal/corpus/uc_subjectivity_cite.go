...
func NewSubjectivityCiteResolver(repo *NoteRepo) SubjectivityCiteLookup {
	if repo == nil {
		return nil
	}
	return &subjectivityCiteResolver{repo: repo}
}
...
func (r *subjectivityCiteResolver) ResolveCite(
	...
	if err != nil {
		if errors.Is(err, ErrNoteNotFound) {
			return SubjectivityCiteRef{}, ErrSubjectivityNotFound
		}
