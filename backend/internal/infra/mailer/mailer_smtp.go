// mailer_smtp.go — the supplier's SMTP outbound transport primitive (net/smtp). The owner
// brings their own SMTP credentials, and mail is relayed through the supplier's smtp protocol
