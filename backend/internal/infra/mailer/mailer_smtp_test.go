...
// be injected). e2e verifies the real send loop end-to-end (supplier-protocol-smtp.spec);
// injection is a security property, locked down here with a pure-logic unit test.
