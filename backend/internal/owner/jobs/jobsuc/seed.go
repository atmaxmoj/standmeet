...
// SeedDeps — the two repositories needed to seed these two builtins. The
// shell (internal/owner/jobs) holds it but doesn't know the domain facades:
// the arch rule says that package can only touch jobsuc's types.
