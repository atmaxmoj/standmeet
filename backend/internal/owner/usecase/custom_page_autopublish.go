// custom_page_autopublish.go — auto-go-live for the reserved `home` page (A Slice 5).
//
...
func AutopublishHomepageOnBuilt(
	ctx context.Context, deps CustomPageDeps, built *entity.CustomPageBuild, log *slog.Logger,
) error {
