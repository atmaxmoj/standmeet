// custom_page_draft.go — reading a page's current draft source files, so the admin editor can
// open an existing page (the mini-IDE at /admin/edit/<slug>). Split from custom_page.go to keep
