...
//
// The ext-mcp block (added in B-3) calls this once per connection
// open/close.
...
// ExtMCPDialed — call once after an ext-mcp block dial succeeds
// (counter +1).
func ExtMCPDialed() { extMCPDialed.Add(1) }

// ExtMCPClosed — call once after an ext-mcp block closes (counter +1).
