...
func committedApplicationView(c *domain.CommittedApplication) committedApplicationViewT {
...
func buildSubmissionHint(c *domain.CommittedApplication) submissionHint {
