// capreg_retrieval_socket_nav.go —— host runners for the navigation ops added on top of the
...
func runCorpusMap(ctx context.Context, l CorpusLister, req *retrievalSockReq) (string, error) {
	var args struct {
...
func runCorpusResolve(ctx context.Context, l CorpusLister, req *retrievalSockReq) (string, error) {
	var args struct {
...
func runCorpusPeek(ctx context.Context, l CorpusLister, req *retrievalSockReq) (string, error) {
	var args struct {
...
func peekOne(ctx context.Context, l CorpusLister, req *retrievalSockReq, path string) corpusStub {
...
func signatureFromEntry(e *CorpusEntry) corpusStub {
	return corpusStub{
