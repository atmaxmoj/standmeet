...
func runCorpusMap(ctx context.Context, l CorpusLister, req *corpusIndexReq) (string, error) {
	var args struct {
...
func runCorpusResolve(ctx context.Context, l CorpusLister, req *corpusIndexReq) (string, error) {
	var args struct {
...
func runCorpusPeek(ctx context.Context, l CorpusLister, req *corpusIndexReq) (string, error) {
	var args struct {
...
func peekOne(ctx context.Context, l CorpusLister, req *corpusIndexReq, path string) corpusStub {
