...
// pathNode —— 算 path 只需要 id / title / parent。corpus.Wiki 和 corpus.Output
...
func WikiTreePaths(ws []corpus.Wiki) map[string]string {
...
func OutputTreePaths(os []corpus.Output) map[string]string {
...
func RawTreePaths(rs []corpus.Raw) map[string]string {
