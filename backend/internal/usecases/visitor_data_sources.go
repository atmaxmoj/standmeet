...
type WikiLister interface {
	ListByOwner(ctx context.Context, ownerID string, limit int32) ([]corpusdomain.Wiki, error)
	Search(
	...
	GetByID(ctx context.Context, ownerID, id string) (corpusdomain.Wiki, error)
}
...
type OutputLister interface {
	ListByOwner(ctx context.Context, ownerID string, limit int32) ([]corpusdomain.Output, error)
	Search(
		ctx context.Context, ownerID, query string, limit, offset int32,
	...
	GetByID(ctx context.Context, ownerID, id string) (corpusdomain.Output, error)
}
...
type WritingLister interface {
	ListPublishedByOwner(ctx context.Context, ownerID string) ([]corpusdomain.Writing, error)
	Search(
		ctx context.Context, ownerID, query string, limit, offset int32,
	) ([]corpusdomain.Writing, error)
	GetPublishedByPath(ctx context.Context, ownerID, path string) (corpusdomain.Writing, error)
}
