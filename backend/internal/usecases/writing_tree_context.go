...
// published 集 → 空上下文。
func WritingNodeContext(writings []corpus.Writing, slug string) WritingContext {
...
func writingIndexAtSlug(writings []corpus.Writing, slug string) (int, bool) {
...
func writingAncestorsOf(
	writings []corpus.Writing, present map[string]bool, idx int,
) []WritingTreeNode {
...
func writingIndexByID(writings []corpus.Writing) map[string]int {
