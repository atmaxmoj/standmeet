...
| §L vault | 🟡 **F-L-2 ✅fixed** (source_path reconcile — real vault: errors 29→0, tree roots 24→5), **F-L-3 ✅fixed** (subjectivity ingests without publish — real vault: subjectivity rows 1→17). F-L-1 (obsidian page dead mockup) remains. L1 classify ✓, L5 links ✓, L10 KaTeX ✓. |
