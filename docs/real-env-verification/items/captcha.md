...
- **Status:** ✅ PASS (real, 2nd pass) — re-verify the gate/request/login lift legs
...
- **Result:** ✅ (verdict flips with the secret: PASS+token → 200, no token → 401, FAIL-secret → 401 `[invalid-input-response]`)
