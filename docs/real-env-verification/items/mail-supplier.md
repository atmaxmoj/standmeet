...
- **Backing e2e:** `mail-connector` · `admin-requests` · `gate-request-access` · `recovery-phrase` · `password-reset` · `supplier-protocol-smtp` · `supplier-openapi-mail` · `supplier-err-smtp-fail` · `supplier-mail-rotate-creds-reverify`.
...
- **Backing test:** `mail-supplier.spec.ts` · `admin-requests.spec.ts` · `gate-request-access.spec.ts`
...
- **Backing test:** `supplier-protocol-smtp.spec.ts` · `supplier-err-smtp-fail.spec.ts` · classification itself → `gap`
...
- **Backing test:** `supplier-openapi-mail.spec.ts`
...
- **Backing test:** `supplier-err-smtp-fail.spec.ts` · the three-way classification → `gap`
...
- **Backing test:** `supplier-mail-rotate-creds-reverify.spec.ts`
