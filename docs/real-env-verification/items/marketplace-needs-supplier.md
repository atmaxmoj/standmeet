# marketplace-needs-supplier — the "needs X connector" hint must track REAL connector state
...
- **Real dep:** A real connector the owner can connect and disconnect (see [[calendar-connect]] / [[mail-supplier]]).
- **Exclusive:** github-api
- **Backing e2e:** `marketplace-needs-supplier.spec.ts`.
...
- **Backing test:** `marketplace-needs-supplier.spec.ts`
