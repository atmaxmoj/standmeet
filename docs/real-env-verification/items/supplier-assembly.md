# supplier-assembly — Connectors: real OpenAPI / proxied call / CalDAV
...
- **Backing e2e:** `supplier-spec-ingest` · `supplier-assemble-from-ui` · `supplier-happy-matrix` · `supplier-openapi-mail`.
...
- **Backing test:** `supplier-spec-ingest.spec.ts`
...
- **Backing test:** `supplier-assemble-from-ui.spec.ts` · the real end-to-end path → `gap`
...
- **Backing test:** `supplier-happy-matrix.spec.ts` · `supplier-openapi-mail.spec.ts`
...
- **Backing test:** `supplier-happy-matrix.spec.ts` (against the mock)
