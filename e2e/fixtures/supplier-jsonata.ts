// supplier-jsonata.ts —— the inline spec + the JSONata bindings (happy / runtime /
// broken) for the §8-C binding contract. Extracted from
// supplier-binding-jsonata.spec.ts to stay under max-lines. e2e never touches
...
// UNKNOWN_SEAM_BINDING —— no matching seam slot (rejected at assembly).
export const UNKNOWN_SEAM_BINDING = { ...SAMPLE_BINDING, seam: 'telepathy' } as const;
