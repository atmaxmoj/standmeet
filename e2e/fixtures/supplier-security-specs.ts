// supplier-security-specs.ts —— the inline specs/bindings/constants for the §8-H
// security contract. Extracted from supplier-security.spec.ts to stay under
...
// SPEC_BENIGN_APIKEY —— a fully valid public-base apiKey supplier, used by the
...
export const BENIGN_API_KEY_SECRET = 'sk_live_uploaded_supplier_secret_DO_NOT_LEAK_42';
...
// benign supplier assembles cleanly (the credential-leak / isolation cases only
