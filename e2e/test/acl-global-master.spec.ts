// acl-global-master.spec.ts —— §B.2 of block-acl-hierarchy-tests.md.
//
// global (block_enabled, live) is the top-level ban master: off overrides
...
test.describe('ACL §B.2 · global is the top ban master', () => {
  ...
  test.afterEach(async () => {
    await setBlockEnabled(seed.request, seed.csrf, CAP, true);
  });
