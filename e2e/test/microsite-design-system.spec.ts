// microsite-design-system.spec.ts —— every microsite build ships the StandMeet design system.
//
// The foundation for homepage-as-microsite (and any styled page): the builder template now
