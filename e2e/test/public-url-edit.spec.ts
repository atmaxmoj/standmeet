// public-url-edit.spec.ts —— the owner edits the public URL in the /admin/page · site
// block; /me immediately reflects the new value; the next application QR issued uses
// the new URL.
//
// User story:
//   The owner initially deploys at http://localhost:38127, then later attaches their
//   own domain, https://alice.dev. They open admin · page · site, click "change" on
//   the public URL row, enter the new URL, and save. /me returns the new value; after
