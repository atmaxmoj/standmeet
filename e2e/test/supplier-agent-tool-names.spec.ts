// supplier-agent-tool-names.spec.ts -- F-C-58: tool names exposed to the visitor AI
// must be names the provider will accept.
//
// In the neighboring spec (supplier-agent-tools), every sample spec's operationId has
...
// sending mail) reach the model. Which means: an owner adds a supplier shaped like
...
test.describe('supplier · agent-tool names must be provider-legal (F-C-58)', () => {
