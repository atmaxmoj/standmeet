// supplier-config-nonidentity-no-disconnect.spec.ts -- Section 3, decision
...
// non-identity field) MUST NOT disconnect the supplier — connected/verified
...
test.describe('supplier · non-identity config edit does NOT disconnect (§3 D-5)', () => {
  let seed: BaseSeed;
