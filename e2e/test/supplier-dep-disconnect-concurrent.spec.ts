// supplier-dep-disconnect-concurrent.spec.ts — fills a gap in the state-change matrix:
...
// recompute of supplier state is **an instance-wide cut**, not per-session. This test
...
test.describe('supplier dep · owner disconnect drops booking for ALL concurrent sessions', () => {
  let seed: CodedSeed;
