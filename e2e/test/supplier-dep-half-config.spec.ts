// supplier-dep-half-config.spec.ts —— fills in the state-transition matrix cell "credentials
...
// a boundary case that fills in the supplier-deps matrix.
//
...
test.describe('supplier dep · credentials saved but OAuth never completed → booking hidden', () => {
  let seed: BaseSeed;
