// supplier-err-confirmation-idempotent.spec.ts — §4 E14
...
import {
  configureMailSupplier, clearMailpit, waitForMailEnvelopeTo, countMailpitMessages,
} from '@/fixtures/mail';
import {
...
test.describe('supplier error stream · confirmation email is idempotent (E14)', () => {
  let seed: CodedSeed;
