// supplier-err-google-5xx.spec.ts — §4 E6
...
//
// RED / TDD: goes green once the supplier proxy maps Google 5xx to a graceful
// degradation.
//
...
test.describe('supplier error stream · Google events.insert 5xx degrades (E6)', () => {
  let seed: CodedSeed;
