// supplier-err-mcp-ui-tool-dispatch.spec.ts —— §4 error stream matrix E12 (R4 new path)
...
import { configureMailSupplier, clearMailpit } from '@/fixtures/mail';
import {
...
test.describe('supplier error stream · mcp-ui:tool dispatch failures degrade in-card (E12)', () => {
  let seed: CodedSeed;
