// supplier-err-midstream-sse-cut.spec.ts — §4 error-stream matrix, E15.
// A supplier-backed tool call's stream is interrupted **while it's in progress** (inside the
...
//
// Error stream E15: the SSE stream is interrupted DURING a supplier-backed tool
...
test.describe('supplier error stream · mid-stream SSE cut during supplier-backed tool call (E15)', () => {
  let seed: CodedSeed;
