// supplier-non-sandbox-cards-empty.spec.ts — once booked's externalization is
// finished, the frontend's NON_SANDBOX_CARDS no longer has any card hardcoded by
// block (only the generic skill_*/ext_* dump fallback remains). Observable
...
// (supplier-deps-tests.md §1 non-sandbox-cards-empty)
//
...
test.describe('supplier · booked card is a sandbox iframe; no hardcoded block card in main DOM', () => {
  let seed: CodedSeed;
