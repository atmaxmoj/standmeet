// supplier-refresh-keeps-scopes.spec.ts -- F-C-43: **a silent refresh must not wipe out
...
// damages -- if the data is right but the block didn't come back, the two lines
