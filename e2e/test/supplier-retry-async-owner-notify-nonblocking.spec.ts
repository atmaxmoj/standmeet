...
import {
  configureMailSupplier, clearMailpit, waitForMailEnvelopeTo, MAIL_FROM,
...
test.describe('supplier retry · owner-notify async, non-blocking, retried in background (R6)', () => {
  let seed: CodedSeed;
  test.beforeAll(async ({ playwright }: { playwright: Playwright }) => {
    ...
    // configureMailSupplier logs in again and rotates CSRF — refresh seed.csrf, otherwise
