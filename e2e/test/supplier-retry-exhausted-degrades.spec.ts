// supplier-retry-exhausted-degrades.spec.ts —— §5 retry matrix · read-op exhaustion
//
...
test.describe('supplier retry · persistent read failure exhausts budget → friendly degrade', () => {
  let seed: CodedSeed;
