// supplier-retry-insert-idempotent.spec.ts —— §five, retry matrix: a write must not double-book
//
...
test.describe('supplier retry · events.insert under transient connection error does not double-book', () => {
  let seed: CodedSeed;
