// supplier-retry-read-transient-recovers.spec.ts -- Section 5 retry matrix, read class
//
...
test.describe('supplier retry · transient read error recovers (visitor still gets slots)', () => {
  let seed: CodedSeed;
