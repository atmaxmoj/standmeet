// supplier-revoked-degrades.spec.ts — Phase B: a supplier is revoked (the owner
// revoked authorization on the Google side) → the next refresh gets invalid_grant →
// the backend recognizes "the supplier is dead" and **degrades gracefully**, no
...
test.describe('Phase B · revoked supplier degrades gracefully', () => {
  let seed: CodedSeed;
