...
// seedCorpusMut / test* —— 抽出 beforeAll + 各 test body 成 module-level
// 函数，让 describe 回调 < 70 行 (max-lines-per-function)。describe 单 worker
// 串行跑，模块级 let 跨 test 共享即原来的 describe-scoped 语义。
