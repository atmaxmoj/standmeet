#!/usr/bin/env python3
# blocks.py —— the durable agentic-block test suite. Replaces the
...
#
#   make eval-blocks                     # all cases
#   EVAL_CASES=booking,skill,mcp make eval-blocks   # substring filter
#
...
def main():
    ...
    try:
        for c in cases:
            ...
            # without a booking hook — five asserts about a block nobody mounted.
            if c.get("needs_mcp"):
                if not mcp_proc:
