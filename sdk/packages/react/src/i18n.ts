...
const en = {
  ...
  errKeyUnreadable: 'The AI key saved in this browser can’t be read any more — add it again.',
...
const zh: Catalog = {
  ...
  errKeyUnreadable: '这个浏览器里保存的 AI key 读不出来了——请重新填一次。',
...
const fr: Catalog = {
  ...
  errKeyUnreadable: 'La clé IA enregistrée dans ce navigateur n’est plus lisible — ajoutez-la à nouveau.',
...
const hi: Catalog = {
  ...
  errKeyUnreadable: 'इस ब्राउज़र में सहेजी गई AI key अब पढ़ी नहीं जा सकती — उसे फिर से जोड़ें।',
...
const de: Catalog = {
  ...
  errKeyUnreadable: 'Der in diesem Browser gespeicherte KI-Schlüssel ist nicht mehr lesbar — füg ihn erneut hinzu.',
...
const ja: Catalog = {
  ...
  errKeyUnreadable: 'このブラウザに保存された AI キーが読み取れなくなりました。もう一度入力してください。',
...
const ko: Catalog = {
  ...
  errKeyUnreadable: '이 브라우저에 저장된 AI 키를 더 이상 읽을 수 없어요. 다시 입력해 주세요.',
...
const es: Catalog = {
  ...
  errKeyUnreadable: 'La clave de IA guardada en este navegador ya no se puede leer — añádela de nuevo.',
